...
class EditPasswordTextFormFiled extends StatefulWidget {
  final String hint;
  final TextEditingController customController;
  const EditPasswordTextFormFiled(
      {super.key, required this.hint, required this.customController});
  @override
  State<EditPasswordTextFormFiled> createState() {
    return _CustomPasswordTextFiledState();
  }
}

class _CustomPasswordTextFiledState extends State<EditPasswordTextFormFiled> {
  bool secure = true;
  @override
